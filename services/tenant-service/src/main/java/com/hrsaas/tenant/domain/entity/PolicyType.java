...
public enum PolicyType {
    ...
    APPROVAL_POLICY,        // 결재 정책 (sample data 호환)
    NOTIFICATION_POLICY,    // 알림 정책 (sample data 호환)
    SECURITY_POLICY,        // 보안 정책 (sample data 호환)
    LEAVE_POLICY,           // 휴가 정책 (sample data 호환)
    WORK_SCHEDULE           // 근무 스케줄 정책
}
