...
-- ============================================================================
\echo '[9/21] 직원 상세 정보 생성 (약 5-10분 소요)...'
...
-- ============================================================================
\echo '[12/21] 근태 기록 대량 생성 (약 15-25분 소요)...'
...
\echo '  - auth-service: 로그인이력 (세션/토큰은 런타임 생성)'
