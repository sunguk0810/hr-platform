...
export const employeeHandlers = [
  ...
  http.get('/api/v1/employees', async ({ request }) => {
    ...
    const status = url.searchParams.get('status') as EmploymentStatus | null;
  ...
  http.post('/api/v1/employees', async ({ request }) => {
    ...
    const newEmployee: Employee = {
      ...
      positionCode: body.positionId as string | undefined,
      positionName: body.positionId ? mockPositions[body.positionId as string] : undefined,
      gradeCode: body.gradeId as string | undefined,
  ...
  http.post('/api/v1/employees/:id/resign', async ({ params, request }) => {
    ...
    mockEmployees[index] = {
      ...mockEmployees[index],
      status: 'RESIGNED',
      resignDate: body.resignDate as string,
