...
const mockTransfers: TransferRequest[] = [
  {
    ...
    sourcePositionName: '팀장',
    sourceGradeId: 'grade-2',
    sourceGradeName: '부장',
    ...
    requesterId: 'user-1',
    requesterName: '박관리',
    sourceApproverId: null,
    sourceApproverName: null,
  ...
  },
  {
    ...
    sourcePositionId: 'pos-3',
    sourcePositionName: '파트장',
    sourceGradeId: 'grade-4',
    sourceGradeName: '연구원',
  ...
  },
  {
    ...
    rejectedBy: 'user-11',
    rejectedByName: '김본부장',
    rejectedAt: '2026-01-19T11:00:00Z',
    rejectionReason: '현재 인사팀 정원 초과로 인력 수용 불가',
    completedAt: null,
    cancelledAt: null,
    cancellationReason: null,
...
export const transferHandlers = [
  ...
  http.post('/api/v1/transfers', async ({ request }) => {
    ...
    const newTransfer: TransferRequest = {
      ...
      employeeName: '신규직원', // Would be fetched from employee service
      ...
      targetDepartmentId: (body as any).targetDepartmentId || null,
      targetDepartmentName: targetDept?.name || null,
      targetPositionId: (body as any).targetPositionId || null,
      targetPositionName: targetPos?.name || null,
      targetGradeId: (body as any).targetGradeId || null,
      targetGradeName: targetGrade?.name || null,
      effectiveDate: (body as any).effectiveDate,
      returnDate: (body as any).returnDate || null,
      reason: (body as any).reason,
      remarks: (body as any).remarks || null,
      handoverItems: (body as any).handoverItems || null,
      requesterId: 'user-1',
      requesterName: '현재사용자',
      sourceApproverId: null,
      sourceApproverName: null,
